...
/**
 * 求人検索ページネーション404問題の修正版
 * functions.phpの既存のリライトルール関数を以下に完全置き換えしてください
 */

/**
 * カスタムリライトルールを追加（ページネーション修正版）
 */
function job_search_rewrite_rules() {
    ...
    add_rewrite_rule(
        '^jobs/features/page/([0-9]+)/?$',
        'index.php?post_type=job&job_features_only=1&paged=$matches[1]',
        'top'
    );
    
    // ===== 5つの条件組み合わせ（最も具体的なルールを最初に） =====
    add_rewrite_rule(
        '^jobs/location/([^/]+)/position/([^/]+)/type/([^/]+)/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_position=$matches[2]&job_type=$matches[3]&facility_type=$matches[4]&job_feature=$matches[5]&paged=$matches[6]',
        'top'
    );
    ...
    // エリア + 職種 + 雇用形態 + 施設形態
    add_rewrite_rule(
        '^jobs/location/([^/]+)/position/([^/]+)/type/([^/]+)/facility/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_position=$matches[2]&job_type=$matches[3]&facility_type=$matches[4]&paged=$matches[5]',
        'top'
    );
    ...
    // エリア + 職種 + 雇用形態 + 特徴
    add_rewrite_rule(
        '^jobs/location/([^/]+)/position/([^/]+)/type/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_position=$matches[2]&job_type=$matches[3]&job_feature=$matches[4]&paged=$matches[5]',
        'top'
    );
    ...
    // エリア + 職種 + 施設形態 + 特徴
    add_rewrite_rule(
        '^jobs/location/([^/]+)/position/([^/]+)/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_position=$matches[2]&facility_type=$matches[3]&job_feature=$matches[4]&paged=$matches[5]',
        'top'
    );
    ...
    // エリア + 雇用形態 + 施設形態 + 特徴
    add_rewrite_rule(
        '^jobs/location/([^/]+)/type/([^/]+)/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_type=$matches[2]&facility_type=$matches[3]&job_feature=$matches[4]&paged=$matches[5]',
        'top'
    );
    ...
    // 職種 + 雇用形態 + 施設形態 + 特徴
    add_rewrite_rule(
        '^jobs/position/([^/]+)/type/([^/]+)/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&job_type=$matches[2]&facility_type=$matches[3]&job_feature=$matches[4]&paged=$matches[5]',
        'top'
    );
    ...
    // エリア + 職種 + 雇用形態
    add_rewrite_rule(
        '^jobs/location/([^/]+)/position/([^/]+)/type/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_position=$matches[2]&job_type=$matches[3]&paged=$matches[4]',
        'top'
    );
    ...
    // エリア + 職種 + 施設形態
    add_rewrite_rule(
        '^jobs/location/([^/]+)/position/([^/]+)/facility/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_position=$matches[2]&facility_type=$matches[3]&paged=$matches[4]',
        'top'
    );
    ...
    // エリア + 職種 + 特徴
    add_rewrite_rule(
        '^jobs/location/([^/]+)/position/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_position=$matches[2]&job_feature=$matches[3]&paged=$matches[4]',
        'top'
    );
    ...
    // エリア + 雇用形態 + 施設形態
    add_rewrite_rule(
        '^jobs/location/([^/]+)/type/([^/]+)/facility/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_type=$matches[2]&facility_type=$matches[3]&paged=$matches[4]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/location/([^/]+)/type/([^/]+)/facility/([^/]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_type=$matches[2]&facility_type=$matches[3]',
        'top'
    );
    
    // エリア + 雇用形態 + 特徴
    add_rewrite_rule(
        '^jobs/location/([^/]+)/type/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_type=$matches[2]&job_feature=$matches[3]&paged=$matches[4]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/location/([^/]+)/type/([^/]+)/feature/([^/]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_type=$matches[2]&job_feature=$matches[3]',
        'top'
    );
    
    // エリア + 施設形態 + 特徴
    add_rewrite_rule(
        '^jobs/location/([^/]+)/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&facility_type=$matches[2]&job_feature=$matches[3]&paged=$matches[4]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/location/([^/]+)/facility/([^/]+)/feature/([^/]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&facility_type=$matches[2]&job_feature=$matches[3]',
        'top'
    );
    
    // 職種 + 雇用形態 + 施設形態
    add_rewrite_rule(
        '^jobs/position/([^/]+)/type/([^/]+)/facility/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&job_type=$matches[2]&facility_type=$matches[3]&paged=$matches[4]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/position/([^/]+)/type/([^/]+)/facility/([^/]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&job_type=$matches[2]&facility_type=$matches[3]',
        'top'
    );
    
    // 職種 + 雇用形態 + 特徴
    add_rewrite_rule(
        '^jobs/position/([^/]+)/type/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&job_type=$matches[2]&job_feature=$matches[3]&paged=$matches[4]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/position/([^/]+)/type/([^/]+)/feature/([^/]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&job_type=$matches[2]&job_feature=$matches[3]',
        'top'
    );
    
    // 職種 + 施設形態 + 特徴
    add_rewrite_rule(
        '^jobs/position/([^/]+)/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&facility_type=$matches[2]&job_feature=$matches[3]&paged=$matches[4]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/position/([^/]+)/facility/([^/]+)/feature/([^/]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&facility_type=$matches[2]&job_feature=$matches[3]',
        'top'
    );
    
    // 雇用形態 + 施設形態 + 特徴
    add_rewrite_rule(
        '^jobs/type/([^/]+)/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_type=$matches[1]&facility_type=$matches[2]&job_feature=$matches[3]&paged=$matches[4]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/type/([^/]+)/facility/([^/]+)/feature/([^/]+)/?$',
        'index.php?post_type=job&job_type=$matches[1]&facility_type=$matches[2]&job_feature=$matches[3]',
        'top'
    );
    ...
    // エリア + 雇用形態
    add_rewrite_rule(
        '^jobs/location/([^/]+)/type/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_type=$matches[2]&paged=$matches[3]',
        'top'
    );
    ...
    // エリア + 施設形態
    add_rewrite_rule(
        '^jobs/location/([^/]+)/facility/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&facility_type=$matches[2]&paged=$matches[3]',
        'top'
    );
    ...
    // エリア + 特徴
    add_rewrite_rule(
        '^jobs/location/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_location=$matches[1]&job_feature=$matches[2]&paged=$matches[3]',
        'top'
    );
    ...
    // 職種 + 雇用形態
    add_rewrite_rule(
        '^jobs/position/([^/]+)/type/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&job_type=$matches[2]&paged=$matches[3]',
        'top'
    );
    ...
    // 職種 + 施設形態
    add_rewrite_rule(
        '^jobs/position/([^/]+)/facility/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&facility_type=$matches[2]&paged=$matches[3]',
        'top'
    );
    ...
    // 職種 + 特徴
    add_rewrite_rule(
        '^jobs/position/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_position=$matches[1]&job_feature=$matches[2]&paged=$matches[3]',
        'top'
    );
    ...
    // 雇用形態 + 施設形態
    add_rewrite_rule(
        '^jobs/type/([^/]+)/facility/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_type=$matches[1]&facility_type=$matches[2]&paged=$matches[3]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/type/([^/]+)/facility/([^/]+)/?$',
        'index.php?post_type=job&job_type=$matches[1]&facility_type=$matches[2]',
        'top'
    );
    
    // 雇用形態 + 特徴
    add_rewrite_rule(
        '^jobs/type/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&job_type=$matches[1]&job_feature=$matches[2]&paged=$matches[3]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/type/([^/]+)/feature/([^/]+)/?$',
        'index.php?post_type=job&job_type=$matches[1]&job_feature=$matches[2]',
        'top'
    );
    
    // 施設形態 + 特徴
    add_rewrite_rule(
        '^jobs/facility/([^/]+)/feature/([^/]+)/page/([0-9]+)/?$',
        'index.php?post_type=job&facility_type=$matches[1]&job_feature=$matches[2]&paged=$matches[3]',
        'top'
    );
    
    add_rewrite_rule(
        '^jobs/facility/([^/]+)/feature/([^/]+)/?$',
        'index.php?post_type=job&facility_type=$matches[1]&job_feature=$matches[2]',
        'top'
    );
...
/**
 * 強制的にリライトルールをフラッシュ（一度だけ実行）
 */
function force_flush_pagination_rules() {
    $flushed = get_option('pagination_rules_flushed_v3');
    if (!$flushed) {
        flush_rewrite_rules();
        update_option('pagination_rules_flushed_v3', true);
        error_log('Pagination rewrite rules flushed - v3');
    }
}
add_action('init', 'force_flush_pagination_rules', 999);


/**
 * リライトルールを強制的にフラッシュする関数（修正版）
 */
function force_flush_rewrite_rules_fix() {
    // リライトルールをフラッシュ
    flush_rewrite_rules();
    
    // ログに記録
    error_log('求人検索リライトルールをフラッシュしました');
}

// テーマ有効化時に実行
add_action('after_switch_theme', 'force_flush_rewrite_rules_fix');

/**
 * 管理画面から手動でリライトルールをフラッシュするための関数
 * 管理画面 > 設定 > パーマリンク設定 で「変更を保存」をクリックするとフラッシュされます
 */
function manual_flush_rewrite_rules() {
    if (is_admin() && current_user_can('manage_options')) {
        if (isset($_GET['page']) && $_GET['page'] === 'permalink' && isset($_POST['submit'])) {
            flush_rewrite_rules();
            error_log('手動でリライトルールをフラッシュしました');
        }
    }
}
add_action('admin_init', 'manual_flush_rewrite_rules');
...
/**
 * jobカスタム投稿タイプの設定確認・修正コード
 * functions.phpに追加してください
 */

/**
 * jobカスタム投稿タイプの設定を確認・登録する関数
 */
function ensure_job_post_type() {
    // 既存のjobカスタム投稿タイプを確認
    if (!post_type_exists('job')) {
        // jobカスタム投稿タイプが存在しない場合は登録
        register_job_post_type();
    } else {
        // 既存の設定を確認してログ出力
        $job_post_type = get_post_type_object('job');
        error_log('Job post type settings:');
        error_log('- has_archive: ' . ($job_post_type->has_archive ? 'true' : 'false'));
        error_log('- public: ' . ($job_post_type->public ? 'true' : 'false'));
        error_log('- publicly_queryable: ' . ($job_post_type->publicly_queryable ? 'true' : 'false'));
        error_log('- rewrite: ' . print_r($job_post_type->rewrite, true));
    }
}

/**
 * jobカスタム投稿タイプを正しい設定で登録
 */
function register_job_post_type() {
    ...
    $args = array(
        ...
        'capability_type' => 'post',
        'has_archive' => true, // 重要：アーカイブページを有効化
        'hierarchical' => false,
        'menu_position' => 5,
    ...
    error_log('Job post type registered with has_archive: true');
}

// 初期化時に実行
add_action('init', 'ensure_job_post_type', 0);

/**
 * アーカイブページの存在確認とデバッグ用関数
 */
function debug_job_archive_status() {
    if (current_user_can('administrator')) {
        // 管理者のみに情報を表示
        $job_post_type = get_post_type_object('job');
        
        if ($job_post_type) {
            echo '<!-- Job Post Type Debug Info:' . PHP_EOL;
            echo 'Has Archive: ' . ($job_post_type->has_archive ? 'true' : 'false') . PHP_EOL;
            echo 'Public: ' . ($job_post_type->public ? 'true' : 'false') . PHP_EOL;
            echo 'Publicly Queryable: ' . ($job_post_type->publicly_queryable ? 'true' : 'false') . PHP_EOL;
            echo 'Rewrite Slug: ' . (is_array($job_post_type->rewrite) ? $job_post_type->rewrite['slug'] : $job_post_type->rewrite) . PHP_EOL;
            echo '-->' . PHP_EOL;
        }
    }
}
add_action('wp_head', 'debug_job_archive_status');

/**
 * リライトルールの強制フラッシュ（一時的）
 */
function force_flush_rewrite_rules_once() {
    $flushed = get_option('job_rewrite_flushed_v2');
    if (!$flushed) {
        flush_rewrite_rules();
        update_option('job_rewrite_flushed_v2', true);
        error_log('Rewrite rules flushed for job post type');
    }
}
add_action('init', 'force_flush_rewrite_rules_once', 999);

/**
 * 現在のリライトルールをログに出力（デバッグ用）
 */
function debug_current_rewrite_rules() {
    if (current_user_can('administrator') && isset($_GET['debug_rewrite'])) {
        ...
        foreach ($wp_rewrite->rules as $pattern => $replacement) {
            if (strpos($pattern, 'jobs') !== false || strpos($replacement, 'job') !== false) {
...
add_action('init', 'debug_current_rewrite_rules', 1000);

/**
 * archive-job.phpファイルの存在確認
 */
function check_job_archive_template() {
    $template_path = get_stylesheet_directory() . '/archive-job.php';
    $parent_template_path = get_template_directory() . '/archive-job.php';
    
    if (file_exists($template_path)) {
        error_log('archive-job.php found in child theme: ' . $template_path);
    } elseif (file_exists($parent_template_path)) {
        error_log('archive-job.php found in parent theme: ' . $parent_template_path);
    } else {
        error_log('archive-job.php not found. Will use default archive.php or index.php');
    }
}
add_action('init', 'check_job_archive_template');

/**
 * WP_Query での job 投稿タイプの確認
 */
function test_job_query() {
    if (current_user_can('administrator') && isset($_GET['test_job_query'])) {
...
add_action('init', 'test_job_query');
